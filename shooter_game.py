...
bots = sprite.Group()
for i in range(3):
    bots.add(EnemySprite('ufo.png', sprite_size,sprite_size,randint(1,win_width-85),randint(10,200),randint(1,3)))
...
reloading = font1.render('Wait, reloading!', True, (180, 0, 0))

#2021.02.28 Новый фон для счетчиков
